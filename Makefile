...
CC=gcc
OUT=bin/dummy
SRC=src/main.c src/game/player.c src/game/zombie.c src/game/game.c src/game/world.c src/game/ui.c src/game/gun.c src/game/projectile.c src/structs/array.c src/utils.c
